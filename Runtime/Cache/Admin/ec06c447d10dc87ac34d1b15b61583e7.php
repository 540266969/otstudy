                        ...
                        <div id="tab1" class="tab-pane tab1 in">
                            ...
                            <div class="form-item cf">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="hidden" name="img" id="cover_id_path" value="<?php echo ((isset($info["img"]) && ($info["img"] !== ""))?($info["img"]):''); ?>"/>
                                    ...
                                    <label class="textarea">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            KindEditor.ready(function(K) {
                                                editor_content = K.create('textarea[name="description"]', {
                                ...
                                <div class="controls">
                                    <label class="textarea">
                                        <textarea name="simple_des"><?php echo ((isset($info["simple_des"]) && ($info["simple_des"] !== ""))?($info["simple_des"]):''); ?></textarea>
                                    </label>
                                </div>
                                <div class="form-item cf">
                                    <label class="item-label">截止日期：</label>
                                    <div class="controls">
                                        <input type="text" class="text time" name="last_time" value="<?php echo ((isset($info["last_time"]) && ($info["last_time"] !== ""))?($info["last_time"]):''); ?>"></div>
                                </div>
                                <div class="form-item cf">
