...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="<?php echo U('nodetail?id='.$list['id']);?>">
            <div class="col-xs-2">
...
<!--<span style="font-size:14px;">$Page->lastSuffix = false;//最后一页不显示为总页数-->
...
<!--$page_show = $page_html($Page->show());//重点在这里-->
<!--$this->assign('page_show'=>$page_show);</span>-->
