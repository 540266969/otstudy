                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="zushouInfo">                                                                      <?php echo ($list['simple_des']); ?>
                                    </p>
                                    <p class="text-danger"><?php echo ($list['price']); ?>元/月</p>
                                    <p><a href="<?php echo U('zsdetail?id='.$list['id']);?>" class="btn btn-danger zushouBtn">详细信息</a></p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h4><?php echo ($list['title']); ?></h4>
                                    <p class="zushouInfo"><?php echo ($list['simple_des']); ?></p>
                                    <p class="text-danger"><?php echo ($list['price']); ?>万元</p>
                                    <p><a href="<?php echo U('zsdetail?id='.$list['id']);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
