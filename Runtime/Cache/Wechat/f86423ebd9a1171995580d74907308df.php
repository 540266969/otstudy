...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:<?php echo ($list['name']); ?><span style="display: inline-block;float: right"><button type="button" class="btn btn-info ajax-page">参加活动</button></span></div>
...
<script>
    var url='/wechat.php?s=/Activity/activity';
    $('.ajax-page').click(function(){
        var document_id=<?php echo ($list['id']); ?>;
        console.log(document_id);
        $.get(url+'/document_id/'+document_id,function(data){
            alert(data);
            if(data=='请先登录'){
                location.href='/wechat.php?s=/User/login';
            }
        })
    })
</script>
